...
VIOLATION_TYPES = {
    "V01": {
        "name": "承诺本金不受损失",
        "keywords": ["保本", "保息", "零风险", "本金无忧", "本金安全", "不损失本金", "本金完全保障", "从未亏损", "无亏损", "不损失", "出现亏损", "亏损"],
        "articles": ["保险销售第21条", "金融网销第8条"],
        "severity": "critical",
    },
    "V02": {
        "name": "承诺确定收益",
        "keywords": ["年化", "稳稳到手", "固定收益", "确定回报", "保证收益", "稳赚", "回报", "翻倍", "每年", "带来"],
        "articles": ["保险销售第21条", "金融网销第8条"],
        "severity": "critical",
    },
    "V03": {
    ...
    "V07": {
        "name": "隐瞒/淡化费用",
        "keywords": ["免保费", "零手续费", "无管理费", "无费用", "免费", "无需支付", "额外费用", "一分不多收"],
        "articles": ["保险销售第21条", "保险销售第25条"],
        "severity": "critical",
    },
    "V08": {
        "name": "诱导退保/转保",
        "keywords": ["退保", "转保", "升级换代", "旧保单", "不划算", "换了买", "终止", "转入", "升级产品"],
        "articles": ["保险销售第27条"],
        "severity": "critical",
    },
    "V09": {
