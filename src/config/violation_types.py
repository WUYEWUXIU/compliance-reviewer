"""
违规类型枚举表（V01-V11 + V00）与合规正向标签（C01-C03）
"""
...
COMPLIANCE_TAGS = {
    "C01": {
        "name": "含法定风险提示",
        "keywords": ["本产品由", "保险公司承保", "犹豫期", "退保损失"],
    },
    "C02": {
        "name": "费用披露完整",
        "keywords": ["手续费", "管理费", "扣除", "费用明细"],
    },
    "C03": {
        "name": "资质公示齐全",
        "keywords": ["备案编号", "销售资质", "执业登记", "机构名称"],
    },
}

NEGATION_PATTERNS = [
    "不保本", "非保本", "不保证", "非保证", "无风险承诺", "不承诺",
    "不存在", "并非", "不等于", "不涉及", "不含", "无", "没有",
]
